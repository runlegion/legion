...
LEGION_SKIP_UNCERTAINTY=1 echo "{\"session_id\":\"skip-session\",\"tool_name\":\"TaskCreate\",\"tool_input\":{\"subject\":\"x\"},\"tool_response\":{\"id\":\"task-skip\"}}" | LEGION_SKIP_UNCERTAINTY=1 bash "$EMIT_HOOK"
LEGION_SKIP_UNCERTAINTY=1 echo "{\"session_id\":\"${SESSION}\",\"tool_name\":\"TaskUpdate\",\"tool_input\":{\"task_id\":\"task-001\",\"status\":\"completed\"}}" | LEGION_SKIP_UNCERTAINTY=1 bash "$WITNESS_HOOK"
