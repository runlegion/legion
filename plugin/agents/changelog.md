...
Your final message is your report, and it reaches your caller (the release pipeline) as your
return value. The changelog entry you wrote is the work product -- the caller reads that file
directly; your report just says what you did and why.
